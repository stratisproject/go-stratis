...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		ShanghaiTime:                   newUint64(1710353050),
		CancunTime:                     newUint64(1710353050),
		StratisMasterNodeForkV2Support: true,
		StratisMasterNodeForkV2Block:   big.NewInt(2587200),
	}
	// AuroriaChainConfig contains the chain parameters to run a node on the Auroria test network.
	AuroriaChainConfig = &ChainConfig{
		ChainID:                        big.NewInt(205205),
		HomesteadBlock:                 big.NewInt(0),
		DAOForkBlock:                   nil,
		DAOForkSupport:                 true,
		EIP150Block:                    big.NewInt(0),
...
var NetworkNames = map[string]string{
	...
	AuroriaChainConfig.ChainID.String(): "auroria",
}
...
type ChainConfig struct {
	...
	StratisMasterNodeForkV2Block   *big.Int `json:"stratisMasterNodeForkV2Block,omitempty"`
	StratisMasterNodeForkV2Support bool     `json:"stratisMasterNodeForkV2Support,omitempty"`
...
// IsStratisMasterNodeForkV2 returns whether num is either equal to the StratisMasterNode fork V2 block or greater.
func (c *ChainConfig) IsStratisMasterNodeForkV2(num *big.Int) bool {
	return isBlockForked(c.StratisMasterNodeForkV2Block, num)
}
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, headNumber *big.Int, headTimestamp uint64) *ConfigCompatError {
	...
	if c.IsStratisMasterNodeForkV2(headNumber) && c.StratisMasterNodeForkV2Support != newcfg.StratisMasterNodeForkV2Support {
		return newBlockCompatError("StratisMasterNode V2 fork support flag", c.StratisMasterNodeForkV2Block, newcfg.StratisMasterNodeForkV2Block)
	}
